export default {
  ...
  inlineCredNew: 'Neue Git-HTTPS-Anmeldedaten',
  ...
  inlineCredCreating: 'Wird erstellt…',
  inlineCredCreate: 'Erstellen und auswählen',
  inlineCredCreateStatus: 'Erstellen der Anmeldedaten fehlgeschlagen ({status})',
