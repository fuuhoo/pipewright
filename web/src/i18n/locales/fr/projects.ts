export default {
  ...
  inlineCredNew: 'Nouvel identifiant Git HTTPS',
  ...
  inlineCredCreating: 'Création…',
  inlineCredCreate: 'Créer et sélectionner',
  inlineCredCreateStatus: 'Échec de la création de l’identifiant ({status})',
