export default {
  ...
  fieldRepo: '仓库地址',
  fieldCredHint: '（仅显示 Git 凭据，不含明文）',
  credLoading: '加载凭据中…',
  credSelect: '选择 Git 凭据',
  credEmptyPre: '尚无 Git 凭据,请先前往',
  credVaultLink: '凭据保险库',
  credEmptyPost: '添加。',
  inlineCredNew: '新建 Git 凭据',
  ...
  inlineCredCreating: '创建中…',
  inlineCredCreate: '创建并选择',
  inlineCredCreateStatus: '凭据创建失败({status})',
