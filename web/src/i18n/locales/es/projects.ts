export default {
  ...
  inlineCredNew: 'Nueva credencial Git HTTPS',
  ...
  inlineCredCreating: 'Creando…',
  inlineCredCreate: 'Crear y seleccionar',
  inlineCredCreateStatus: 'Error al crear la credencial ({status})',
