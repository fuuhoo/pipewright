export default {
  ...
  fieldCredHint: '(only Git credentials are shown, never plaintext)',
  credLoading: 'Loading credentials…',
  credSelect: 'Select a Git credential',
  credEmptyPre: 'No Git credentials yet. Go to the',
  credVaultLink: 'credential vault',
  credEmptyPost: 'to add one.',
  inlineCredNew: 'New Git credential',
  ...
  inlineCredCreating: 'Creating…',
  inlineCredCreate: 'Create and select',
  inlineCredCreateStatus: 'Credential creation failed ({status})',
